...
> **⚠ HISTORICAL — superseded by [`docs/CURRENT_STATUS.md`](CURRENT_STATUS.md).**
> This file was last updated 2026-07-23 and predates the feedback/review
> system, collector-health hardening, OEM expansion (Stage 4), and the
> dashboard integration pass (Stage 5-prep). It is kept for historical
> context only — do NOT treat anything below as current state. Start a new
> session by reading `docs/CURRENT_STATUS.md` instead; update that file at
> checkpoints, not this one.
