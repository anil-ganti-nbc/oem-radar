...
rem Webhook: prefer env var, else the file-based one (config\discord_webhook.txt).
rem The CLI already reads config\discord_webhook.txt, so nothing to set here.
